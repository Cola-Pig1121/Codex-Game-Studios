...
- If yes: update the relevant systems' Status field to "Needs Revision"
  ...
  Ask for verification before writing.
...
Use `AskUserQuestion` for the write Verification:
...
For `rtm` mode, additionally ask: "I will write the full Requirements Traceability
...
Also ask: "I will update `docs/architecture/tr-registry.yaml` with new requirement
