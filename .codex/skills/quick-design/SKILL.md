...
## 4. Verification and Filing

Present the draft to the user in full. Then ask:

"I will write this Quick Design Spec to
...
"This spec modifies rules in [System Name]. I will update
...
make GDD edits without explicit Verification.
...
System: [system name]
GDD update: [Required — pending Verification / Applied / Not required]
