...
Ask: "I will write the systems index to `design/gdd/systems-index.md`?"

Wait for verification. Write the file only after "yes."
...
1. **Inspect -> Options when needed -> Decide -> Draft -> Verify** at every step
2. **AskUserQuestion** at every decision point (Explain -> Capture pattern):
   ...
   - Phase 5: "I will write the systems index?"
   - Phase 6: "Start designing, pick different, or stop?" then hand off to `/design-system`
3. **"I will write to [filepath]?"** before every file write
