...
Present the proposed layer assignment and ask for verification before proceeding to
...
Get user Verification on the ownership map before writing.
...
Get user Verification per scenario before writing.
...
Ask: "I will write the master architecture document to `docs/architecture/architecture.md`?"
...
Ask: "I will update the Document Status section in `docs/architecture/architecture.md` with the sign-off?"
...
4. **Get Verification before writing** — each phase section is written only after
