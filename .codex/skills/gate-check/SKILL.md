...
**Always ask before writing**: "Gate passed. I will update `production/stage.txt` to 'Production'?"
...
- **No accessibility requirements doc?** → Use `AskUserQuestion` to offer to create it now:
  ...
  - Then write `design/accessibility-requirements.md` using the template at `.codex/docs/templates/accessibility-requirements.md`, filling in the chosen tier. Confirm: "I will write `design/accessibility-requirements.md`?"
...
5. **Get Verification**: "I will write this gate check report to production/gate-checks/?"
