...
Ask: "I will update the quarantine section of `tests/regression-suite.md`
...
Ask (separately): "I will write a full flakiness report to
`production/qa/flakiness-report-[date].md`?"
...
- **Ask before writing** — both the regression-suite update and the report
  file require explicit Verification. On write: Verdict: **COMPLETE** — flakiness report written. On decline: Verdict: **BLOCKED** — user declined write.
