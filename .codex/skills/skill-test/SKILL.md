...
- `"I will write"` (canonical form)
- `"before writing"` or `"Verification"` near file-write instructions
...
Check 4 — Collaborative Protocol: PASS ("I will write" found)
...
- Check whether the skill requires "I will write" before file writes
- Check whether the skill presents findings before writing
- Check whether the skill ends with a recommended next step
- Check whether the skill avoids auto-creating files without verification
...
Protocol Compliance:
  [PASS] Uses "I will write" before file writes
  [PASS] Presents findings before asking Verification
...
"I will write these results to `CCGS Skill Testing Framework/results/skill-test-spec-[name]-[date].md`
...
"I will update `CCGS Skill Testing Framework/catalog.yaml` to record this category check
