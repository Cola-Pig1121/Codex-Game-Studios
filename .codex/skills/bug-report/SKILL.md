...
Ask: "I will update `production/qa/bugs/[BUG-ID].md` to set Status: Verified Fixed / Still Present / Cannot Verify?"
...
Ask: "I will update `production/qa/bugs/[BUG-ID].md` to mark it Closed?"
...
Ask: "I will write this to `production/qa/bugs/BUG-[NNNN].md`?"
