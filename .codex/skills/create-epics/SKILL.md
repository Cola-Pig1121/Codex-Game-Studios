...
after verification, ask: "I will write the epic file to `production/epics/[epic-slug]/EPIC.md`?"
...
3. **Ask before writing** — per-epic Verification before writing any file
