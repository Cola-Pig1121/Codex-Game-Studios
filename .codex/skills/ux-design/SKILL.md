...
6. **Verification**: "Does this capture it? Any changes before I write it to the file?"
...
- Present the resulting hierarchy for verification before moving to zones.
...
Present the collected states as a table for verification:
