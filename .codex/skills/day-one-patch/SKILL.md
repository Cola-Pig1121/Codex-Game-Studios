...
| Cert feedback requirement | Yes — required for platform Verification |
...
Present the rollback plan. Ask: "I will write this rollback plan to `production/releases/rollback-plan-[version].md`?"
...
## Verifications Required Before Deploy
...
Ask: "I will write this patch record to `production/releases/day-one-patch-[version].md`?"
