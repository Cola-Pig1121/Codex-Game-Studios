...
## Phase 6: Show Draft and Request Verification
...
I will write this to design/gdd/[system-name].md?
```

Wait for verification. User may request changes before writing.
...
7. **Get Verification**: "I will write to [filepath]?" after verification: Verdict: **COMPLETE** — document generated. On decline: Verdict: **BLOCKED** — user declined write.
