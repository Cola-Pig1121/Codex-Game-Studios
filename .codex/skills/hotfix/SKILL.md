---
name: hotfix
description: "Emergency fix workflow that bypasses normal sprint processes with a full audit trail. Creates hotfix branch, tracks Verifications, and ensures the fix is backported correctly."
...
Ask: "I will write this to `production/hotfixes/hotfix-[date]-[short-name].md`?"
...
after verifications, determine the QA scope required before deploying the hotfix. Spawn `qa-lead` via Task with:
...
**Verifications**: lead-programmer ✓ / qa-tester ✓ / producer ✓
