...
Ask: "I will write these engine settings to `AGENTS.md`?"
...
Wait for verification before writing the file.
...
Ask: "I will update the `@` import in `AGENTS.md` to point to the new engine reference?"
