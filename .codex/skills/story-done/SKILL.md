...
Ask before writing: "I will update the story file to mark it Complete and log
...
4. **Update `production/sprint-status.yaml`** (if it exists):
   ...
   - This is a silent update — no extra Verification needed (already approved in step above)
...
- **Never mark a story complete without user Verification** — Phase 7 requires an
