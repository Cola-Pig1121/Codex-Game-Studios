...
### 6. Request Verification Before Writing
...
I will write the full stage analysis to production/project-stage-report.md?
```

Wait for user Verification before creating the file.
...
5. **Get Verification**: "I will write to production/project-stage-report.md?"
