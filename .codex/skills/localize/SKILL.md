...
Present the diff to the user. Ask: "I will write these new entries to `assets/data/strings/strings-en.json`?"
...
Ask: "I will write this translator brief to `production/localization/translator-brief-[locale]-[date].md`?"
...
Ask: "I will write this cultural review report to `production/localization/cultural-review-[date].md`?"
...
Ask: "I will write the VO recording scripts to `production/localization/vo-scripts-[locale]-[date].md`?"
...
Ask: "I will write this RTL check report to `production/localization/rtl-check-[date].md`?"
...
Ask: "I will write this localization QA report to `production/localization/loc-qa-[locale]-[date].md`?"
