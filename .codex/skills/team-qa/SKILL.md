...
Ask: "I will write the QA plan to `production/qa/qa-plan-[sprint]-[date].md`?"

Write only after receiving Verification.
...
Ask: "I will write this QA sign-off report to `production/qa/qa-signoff-[sprint]-[date].md`?"
