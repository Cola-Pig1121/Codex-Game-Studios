---
name: "design-review"
description: "Review a game design document for completeness, internal consistency, implementability, and adherence to project design standards before handing it to programmers."
---
...
- Prompt: "I will update `design/gdd/systems-index.md` to mark [system] as [In Review / Approved]?"
