...
- Ask: "I will update the status in [ADR filename]?"
...
Ask: "I will update the traceability index?"

---

## 9. Output Change Impact Document

Ask: "I will write the change impact report to `docs/architecture/change-impact-[date]-[system-slug].md`?"
