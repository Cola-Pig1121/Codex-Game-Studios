...
- **Tier 1 (gpt-5.5 xhigh)**: Directors who make high-level decisions
...
- **Tier 2 (gpt-5.5 medium)**: Department leads who own their domain
  - `game-designer`, `lead-programmer`, `art-director`, `audio-director`,
    `narrative-director`, `qa-lead`, `release-manager`, `localization-lead`

- **Tier 3 (gpt-5.5 medium/low)**: Specialists who execute within their domain
...
- `design-agent-protocol.md` -- question-options-draft-Verification cycle for design agents
