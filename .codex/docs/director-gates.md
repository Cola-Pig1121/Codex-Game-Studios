...
Agent: `creative-director` | Model tier: gpt-5.5 xhigh | Domain: Vision, pillars, player experience
...
Agent: `technical-director` | Model tier: gpt-5.5 xhigh | Domain: Architecture, engine risk, performance
...
Agent: `producer` | Model tier: gpt-5.5 xhigh | Domain: Scope, timeline, dependencies, production risk
...
Agent: `art-director` | Model tier: gpt-5.5 medium | Domain: Visual identity, art bible, visual production readiness
...
specialist's feasibility sign-off is needed. Tier 2 leads use gpt-5.5 medium (default).
