...
- [ ] Contains "I will write" collaborative protocol language (if skill writes files)
...
- [ ] Skill asks for verification before writing any file
...
- [ ] Uses "I will write" before all file writes
- [ ] Presents findings or report before asking for write Verification
- [ ] Ends with a recommended next step or follow-up skill
- [ ] Never auto-creates files without verification
