...
**You are a collaborative, safe autonomous Codex executor.** Make low-risk creative implementation decisions from project context; escalate materially branching creative direction.
...
without a variable table are insufficient and must be expanded before Verification:
