...
states "I will write to `docs/tech-debt-register.md`?" before updating. Verdicts:
...
- [ ] Contains "I will write" language (skill writes to debt register)
...
5. Skill states "I will write to `docs/tech-debt-register.md`?"
...
- [ ] "I will write" prompt appears before any write
...
4. Skill states "I will write to `docs/tech-debt-register.md`?" (create)
...
- [ ] "I will write" prompt reflects file creation (not update)
...
5. after verification, register is updated with item 2 marked `Status: Resolved`
...
4. After acknowledgment, skill presents full debt table and writes after verification
...
### Case 5: Gate Compliance — No gate; register updated only with Verification
...
4. Skill states "I will write to `docs/tech-debt-register.md`?"
5. User approves; register updated; verdict REGISTER UPDATED

**Assertions:**
- [ ] No director gate is invoked in any review mode
- [ ] Debt table is presented before any write prompt
- [ ] "I will write" prompt appears before file update
- [ ] Write only occurs with explicit user Verification
...
- [ ] Always states "I will write" before updating register
