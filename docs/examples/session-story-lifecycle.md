...
>
> I will write this to `production/stories/STORY-MOV-001.md` and set Status to `ready-for-dev`?
...
>
> I will update the story status to `Status: Complete` and add Completion Notes, and update `production/sprint-status.yaml`?
